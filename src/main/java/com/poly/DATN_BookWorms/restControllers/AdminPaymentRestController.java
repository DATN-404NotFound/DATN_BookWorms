...
import com.poly.DATN_BookWorms.configuration.PaymentConfig;
import com.poly.DATN_BookWorms.entities.PaymentShop;
import com.poly.DATN_BookWorms.repositories.PaymentShopRepo;
...
public class AdminPaymentRestController {
    ...
    public void paymentCallback(@RequestParam Map<String, String> queryParams, HttpServletResponse response)
        ...
        if (paymentShopId != null && !paymentShopId.equals("")) {
            if ("00".equals(vnp_ResponseCode)) {
                ...
                ShopOnline shopOnlines = paymentShopRepo.findShopId(paymentShop.getShopOnline().getShopid());

                System.out.println("hi " + paymentShop.getShopOnline().getTotal());
                ...
                mailInfo.setTo(paymentShop.getShopOnline().getAccount().getEmail());
    ...
    public Booking create(JsonNode json) {
