...
@Service
public class IMail implements MailService{
	private static final Logger logger = LogManager.getLogger();
	
	private List<MailInformationResponse> listMails = new ArrayList<>();
	
	@Autowired
	JavaMailSender sender;
	
	@Override
	public void send(MailInformationResponse mail) throws MessagingException {
	...
	public void send(String to, String subject, String body) throws MessagingException {
		...
		MailInformationResponse mailin = new MailInformationResponse(to, subject, body);
	...
	@Override
	public void queue(MailInformationResponse mail) {
	...
	public void queue(String to, String subject, String body) {
		...
		queue(new MailInformationResponse(to, subject, body));
	...
	public void run() {
		while (!listMails.isEmpty()) {
			MailInformationResponse mail = listMails.remove(0);
			try {
				this.send(mail);
			} catch (Exception e) {
				e.printStackTrace();
