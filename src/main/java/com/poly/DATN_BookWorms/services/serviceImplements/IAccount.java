...
@Service
public class IAccount implements AccountService {
	...
	public void save(AccountDto accountDTO) {
		...
		try {
			...
			Role role = roleRepo.findById("GUEST").get();

			if (role == null) {
				role = roleRepo.save(new Role("GUEST", "Guest", null));
			}
			...
			authoritiesRepo.save(new Authority(authorityId, account, role));
