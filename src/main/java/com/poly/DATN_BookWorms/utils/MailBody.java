...
public class MailBody {
    ...
    public String mailBody(String fullNameOfAccount, int OTP) {
        return "<!DOCTYPE html>\r\n"
                ...
                + "                - Fanpage của Ibook: https://facebook.com/IBook.vn <br>\r\n"
    ...
    public String mailHuyDon(String personReceive, String personCandle, Booking booking, String status) {
        ...
        return "<!DOCTYPE html>\r\n"
                ...
                + "    <div style=\" width:100%;\">\r\n"
                + "\r\n"
                + "        <p>Kính gửi : <b>" + personReceive + "</b> .</p>\r\n"
                + "        <br>\r\n"
                ...
                + "            <p>Cảm ơn bạn rất nhiều vì đã sử dụng dịch vụ IBook</p>\r\n"
                + "            <p>Chúng tôi nhận được thông tin yêu cầu huỷ đơn hàng từ " + personCandle + "</p>\r\n"
                ...
                + "\r\n"
                + "    Mã đơn hàng             :      <b>" + booking.bookingid + "</b>\r\n"
                + "    Thời gian đặt hàng      :      <b>" + new SimpleDateFormat("dd-MM-yyyy").format(booking.getCreateat()) + "</b>\r\n"
                + "    Tổng tiền đơn hàng      :      <b>" + booking.getCost() + "</b>\r\n"
                + "    Số lượng sản phẩm       :      <b>" + booking.getListOfDetailBooking().size() + "</b>\r\n"
                + " </pre>\r\n"
    ...
    public String mailSuccess(String personReceive, String personCandle, Booking booking, String status, int count) {
        return "<!DOCTYPE html>\r\n"
                + "<html lang=\"en\">\r\n"
                + "\r\n"
                + "<head>\r\n"
                ...
                + "    <div style=\" width:100%;\">\r\n"
                + "\r\n"
                + "        <p>Chào bạn : <b>" + personReceive + "</b> .</p>\r\n"
                + "        <br>\r\n"
                + "        <div class=\"mt-4 p-5\" style=\"border: 1px solid rgb(187, 187, 186); width: 95%; margin: auto;\">\r\n"
                + "            <p style=\"font-size: 20px;\">Thông báo :<span><strong> ĐẶT HÀNG THÀNH CÔNG</strong></span></p>\r\n"
                + "            <p>Cảm ơn bạn rất nhiều vì đã sử dụng dịch vụ IBook</p>\r\n"
                + "            <p>Chúng tôi xin trân trọng thông báo rằng đơn hàng của khách hàng " + personCandle + " Đã được tạo thành công </p>\r\n"
                + "            <p>Thông tin đơn hàng tổng quát :</p>\r\n"
                + "            <pre style=\"font-size: 13px;  box-shadow: 1px 2px 4px 4px rgba(0,0,0,.25); width: 400px;\">\r\n"
                + "\r\n"
                + "    Mã đơn hàng             :      <b>" + booking.bookingid + "</b>\r\n"
